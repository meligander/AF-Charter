...
export const DAILYPAYMENTS_LOADED = "DAILYPAYMENTS_LOADED";
export const WEEKLYPAYMENTS_LOADED = "WEEKLYPAYMENTS_LOADED";
export const MONTHLYPAYMENTS_LOADED = "MONTHLYPAYMENTS_LOADED";
export const PAYMENT_REGISTERED = "PAYMENT_REGISTERED";
export const PAYMENT_CANCELED = "PAYMENT_CANCELED";
export const PAYMENTS_CLEARED = "PAYMENTS_CLEARED";
...
export const MAINTENANCES_LOADED = "MAINTENANCES_LOADED";
export const NEWJOBNUMBER_LOADED = "NEWJOBNUMBER_LOADED";
export const MAINTENANCE_REGISTERED = "MAINTENANCE_REGISTERED";
export const MAINTENANCE_UPDATED = "MAINTENANCE_UPDATED";
export const MAINTENANCE_DELETED = "MAINTENANCE_DELETED";
export const MAINTENANCES_CLEARED = "MAINTENANCES_CLEARED";
export const MAINTENANCE_CLEARED = "MAINTENANCE_CLEARED";
export const MAINTENANCES_ERROR = "MAINTENANCES_ERROR";
export const REMOVEMAINTENANCE_ERROR = "REMOVEMAINTENANCE_ERROR";
